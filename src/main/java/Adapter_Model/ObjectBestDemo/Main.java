...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SumSung mysumSung = new SumSung();
        mysumSung.setTwoPinSoket(twoPinSoketChina);
        mysumSung.chargeRequest();
